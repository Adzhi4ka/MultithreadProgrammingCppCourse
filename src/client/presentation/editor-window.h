...
class EditorWindow : public QMainWindow {
    ...
    public:
        ...
        static EditorWindow* createReadOnly(application::ClientRuntime& runtime, QString title, QByteArray content,
                                            QWidget* parent = nullptr);
        static EditorWindow* createEditable(application::ClientRuntime& runtime, qint64 fileId, qint64 lockToken,
                                            QString logicalName, QByteArray content, QWidget* parent = nullptr);
    ...
    private:
        ...
        EditorWindow(application::ClientRuntime& runtime, QString title, QByteArray content,
                     std::optional<qint64> fileId, std::optional<qint64> lockToken, QWidget* parent = nullptr);
