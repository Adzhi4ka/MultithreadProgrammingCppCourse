...
namespace client::presentation {
    ...
    FileTreeWidget::FileTreeWidget(QWidget* parent)
        : QTreeWidget(parent) {
        setHeaderLabels({QStringLiteral("Name"),
    ...
    qsizetype FileTreeWidget::fileCount() const noexcept {
        return m_filesById.size();
    }
    ...
    QTreeWidgetItem* FileTreeWidget::ensureFolderItem(const QString& pathPart, QTreeWidgetItem* parent, const QString& fullPath) {
    ...
    void FileTreeWidget::emitSelection() {
