...
class FileAclApi : public QObject {
    ...
    public:
        ...
        void setGroupAcl(qint64 fileId, qint64 groupId, AclLevel aclLevel,
                         std::function<void(ApiResult<FileAcl>)> callback);
        void removeGroupAcl(qint64 fileId, qint64 groupId, std::function<void(ApiResult<void>)> callback);
        void getGroupAcl(qint64 fileId, qint64 groupId, std::function<void(ApiResult<FileAcl>)> callback);
        void getUserAcl(qint64 fileId, qint64 userId, std::function<void(ApiResult<UserFileAcl>)> callback);
        void getByFile(qint64 fileId, std::function<void(ApiResult<std::vector<FileAcl>>)> callback);
        void getByGroup(qint64 groupId, std::function<void(ApiResult<std::vector<FileAcl>>)> callback);
