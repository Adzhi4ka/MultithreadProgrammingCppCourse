...
namespace client::infrastructure::api {
    ...
    FileContentApi& RemoteApiGateway::contentApi() noexcept {
        return m_contentApi;
    }

    FileLockApi& RemoteApiGateway::lockApi() noexcept {
        return m_lockApi;
    }

    FileAclApi& RemoteApiGateway::aclApi() noexcept {
        return m_aclApi;
    }

    FileVersionApi& RemoteApiGateway::versionApi() noexcept {
        return m_versionApi;
    }

    GroupApi& RemoteApiGateway::groupApi() noexcept {
        return m_groupApi;
    }
    ...
    void RemoteApiGateway::stopNotifications() {
        m_notificationStreamClient.stop();
    }
