...
FileVersionApi::FileVersionApi(ApiClient& apiClient, QObject* parent) : QObject(parent), m_apiClient(apiClient) {}

void FileVersionApi::create(qint64 fileId, const QString& logicalNameSnapshot,
...
void FileVersionApi::getCurrent(qint64 fileId, std::function<void(ApiResult<FileVersion>)> callback) {
    ...
    m_apiClient.get("/api/file-versions/current", query,
