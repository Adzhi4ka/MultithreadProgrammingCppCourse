...
inline bool canRead(AclLevel level) noexcept { return level == AclLevel::ReadOnly || level == AclLevel::ReadWrite; }

inline bool canWrite(AclLevel level) noexcept { return level == AclLevel::ReadWrite; }
