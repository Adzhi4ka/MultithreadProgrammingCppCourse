...
SqliteDatabase::SqliteDatabase(DatabaseFactory& factory)
    : m_writerCon(factory.createWriter()),
      m_writerBinSem(1),
...
void SqliteDatabase::releaseWriter() { m_writerBinSem.release(); }
