...
FileStorage FileStorage::openReadOnly(uint64_t path) { return FileStorage(openImpl(fillAsciiHex(path), O_RDONLY, 0)); }

FileStorage FileStorage::openWriteOnly(uint64_t path) { return FileStorage(openImpl(fillAsciiHex(path), O_WRONLY, 0)); }

FileStorage FileStorage::openReadWrite(uint64_t path) { return FileStorage(openImpl(fillAsciiHex(path), O_RDWR, 0)); }
