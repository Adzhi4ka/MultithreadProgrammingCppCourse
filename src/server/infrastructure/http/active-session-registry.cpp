...
void ActiveSessionRegistry::publishToUser(int64_t userId, const std::string& eventName, const std::string& data) {
...
void ActiveSessionRegistry::publishToAll(const std::string& eventName, const std::string& data) {
