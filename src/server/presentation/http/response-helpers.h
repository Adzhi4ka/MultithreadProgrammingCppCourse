...
namespace presentation::http {
    ...
    inline infrastructure::http::Response makeBadRequestResponse(unsigned version,
                                                                 bool keepAlive,
    ...
    inline infrastructure::http::Response makeServiceErrorResponse(unsigned version,
                                                                   bool keepAlive,
        ...
        switch (error) {
            ...
            case domain::services::ServiceError::Forbidden:
                return infrastructure::http::makeJsonResponse(http::status::forbidden,
                                                              "{\"error\":\"" + std::string(forbiddenMessage) + "\"}",
                                                              version,
                                                              keepAlive);
