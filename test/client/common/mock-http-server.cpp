...
namespace tests::client {
    ...
    namespace {
        ...
        QByteArray normalizedHeaderName(QByteArray name) {
    ...
    qsizetype MockHttpServer::requestCount() const noexcept {
        return m_requests.size();
    }

    QList<MockHttpRequest> MockHttpServer::requests() const {
        return m_requests;
    }
    ...
    void MockHttpServer::addRoute(QByteArray method,
                                  QString path,
