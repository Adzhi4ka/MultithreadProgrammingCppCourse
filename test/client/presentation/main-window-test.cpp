...
namespace tests::client {
    ...
    TEST(ClientUiTest, MainWindow_Startup_LoadsFilesThroughRuntimeSignal) {
        ...
        server.addRoute("GET", "/api/files", [](const MockHttpRequest&) {
            return MockHttpResponse{
                .status = 200,
                .body = R"({"items":[{"id":10,"fullLogicalName":"/docs/a.txt","currentVersionId":100,"maxVersionCount":5,"createdAt":111,"createdBy":7},{"id":11,"fullLogicalName":"/docs/b.txt","currentVersionId":101,"maxVersionCount":3,"createdAt":112,"createdBy":7}]})"
            };
        });
    ...
    TEST(ClientUiTest, MainWindow_FileLockedNotification_RefreshesFilesAndShowsLockInGui) {
        ...
        server.addRoute("GET", "/api/files", [](const MockHttpRequest&) {
            return MockHttpResponse{
                .status = 200,
                .body = R"({"items":[{"id":42,"fullLogicalName":"/docs/report.txt","currentVersionId":100,"maxVersionCount":5,"createdAt":111,"createdBy":7}]})"
            };
        });
        ...
        *lockActive = true;
        ...
        ASSERT_TRUE(waitUntil([&]() {
            ...
            return file.has_value()
                   && file->hasActiveLock
                   && file->lockedByUserId.value_or(0) == 55;
        }, 5000));
    ...
    TEST(ClientUiTest, MainWindow_GroupAssignedNotification_ReloadsFilesAndShowsNewFileInGui) {
        ...
        server.addRoute("GET", "/api/files", [showSharedFile](const MockHttpRequest&) {
            if (!*showSharedFile) {
                return MockHttpResponse{
                    .status = 200,
                    .body = R"({"items":[{"id":10,"fullLogicalName":"/docs/a.txt","currentVersionId":100,"maxVersionCount":5,"createdAt":111,"createdBy":7}]})"
                };
            }

            return MockHttpResponse{
                .status = 200,
                .body = R"({"items":[{"id":10,"fullLogicalName":"/docs/a.txt","currentVersionId":100,"maxVersionCount":5,"createdAt":111,"createdBy":7},{"id":20,"fullLogicalName":"/shared/new-role-file.txt","currentVersionId":200,"maxVersionCount":3,"createdAt":222,"createdBy":8}]})"
            };
        });
        ...
        ASSERT_TRUE(waitUntil([&]() {
            return fileTree->fileCount() == 1 && fileTree->fileById(10).has_value();
        }, 5000));
        ...
        *showSharedFile = true;
        ...
        ASSERT_TRUE(waitUntil([&]() {
            return fileTree->fileCount() == 2 && fileTree->fileById(20).has_value();
        }, 5000));
