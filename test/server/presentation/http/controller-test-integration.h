...
namespace tests {
    ...
    class ControllerIntegrationTest : public ::testing::Test {
        ...
        protected:
            ...
            http::response<http::string_body> request(http::verb method,
                                                      std::string target,
                                                      std::string body = {},
            ...
            int64_t createFile(const std::string& token,
                               const std::string& logicalName,
                               uint32_t maxVersionCount = 10);

            void setGroupAcl(const std::string& token,
                             int64_t fileId,
                             int64_t groupId,
                             std::string_view aclLevel);

            int64_t createVersion(const std::string& token,
                                  int64_t fileId,
