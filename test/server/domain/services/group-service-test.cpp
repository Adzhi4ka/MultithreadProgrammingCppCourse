...
namespace tests {
    ...
    TEST_F(ServiceIntegrationTest, AddUserToGroup_ReturnsConflict_WhenMembershipAlreadyExists) {
        ...
        auto firstAddMembershipResult =
            m_groupService->addUserToGroup(*addUserResult, *createGroupResult);
        ASSERT_TRUE(firstAddMembershipResult.has_value());

        auto secondAddMembershipResult =
            m_groupService->addUserToGroup(*addUserResult, *createGroupResult);
    ...
    TEST_F(ServiceIntegrationTest, RemoveUserFromGroup_RemovesMembership) {
        ...
        auto removeMembershipResult =
            m_groupService->removeUserFromGroup(*addUserResult, *createGroupResult);
    ...
    TEST_F(ServiceIntegrationTest, GetUserGroups_ReturnsAllGroupsOfUser) {
        ...
        auto addFirstMembershipResult =
            m_groupService->addUserToGroup(*addUserResult, *firstGroupResult);
        ASSERT_TRUE(addFirstMembershipResult.has_value());

        auto addSecondMembershipResult =
            m_groupService->addUserToGroup(*addUserResult, *secondGroupResult);
