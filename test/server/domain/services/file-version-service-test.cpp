...
TEST_F(ServiceIntegrationTest, CreateNewVersion_CreatesSecondVersion) {
    ...
    auto createVersionResult = m_fileVersionService->createNewVersion(*createFileResult, "file.txt", 222);
...
TEST_F(ServiceIntegrationTest, CreateNewVersion_UpdatesCurrentVersion) {
    ...
    auto createVersionResult = m_fileVersionService->createNewVersion(*createFileResult, "file_v2.txt", 222);
    ASSERT_TRUE(createVersionResult.has_value());
...
TEST_F(ServiceIntegrationTest, CreateNewVersion_IncrementsVersionNumber) {
    ...
    auto secondVersionResult = m_fileVersionService->createNewVersion(*createFileResult, "file_v2.txt", 222);
    ASSERT_TRUE(secondVersionResult.has_value());

    auto thirdVersionResult = m_fileVersionService->createNewVersion(*createFileResult, "file_v3.txt", 333);
...
TEST_F(ServiceIntegrationTest, CreateNewVersion_ReturnsNotFound_WhenFileDoesNotExist) {
    auto createVersionResult = m_fileVersionService->createNewVersion(999999, "ghost.txt", 111);
